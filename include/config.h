...
#define MAX_REF_INTPUT	1 //!< Maximum value for input reference. \details Maximum value for the input reference in the control model. Signals from SBUS (int16_t) are remapped within #MIN_CH_SBUS and #MAX_CH_SBUS as float numbers. \see MIN_CH_SBUS CONVERT_CHANNEL_TO_FLOAT
